...
def checar_eeat(html):
    ...
    if re.search(
        r"n[ãa]o (?:realizamos|fizemos|conduzimos) (?:testes?|ensaios?)"
        r"|n[ãa]o (?:testamos|testei|avaliamos)\b[^.]{0,60}\bfisicamente"
        r"|n[ãa]o (?:testamos|testei|avaliamos) (?:esta|este|essa|esse|a|o) \w+"
